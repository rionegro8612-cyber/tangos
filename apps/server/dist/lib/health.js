...
class ErrorRateTracker {
    ...
    addRequest(endpoint, isError = false) {
        this.cleanOldData();
...
exports.errorTracker = new ErrorRateTracker();
/**
 * 데이터베이스 헬스체크
 */
...
async function checkErrorRate() {
    const errorRate = exports.errorTracker.getErrorRate();
