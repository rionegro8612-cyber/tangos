...
export const newLog = {
  ...
  // ===== OTP 관련 로깅 (보안 강화) =====
  otp: {
    send: (status: 'success' | 'fail', requestId: string, phone: string, ip: string, provider: string, carrier: string, userId?: string, error?: string) => {
    ...
    verify: (status: 'success' | 'fail', code: string, httpStatus: number, requestId: string, phone: string, ip: string, userId?: string, latencyMs?: number, error?: string) => {
  ...
  auth: {
    login: (status: 'success' | 'fail', requestId: string, phone: string, ip: string, userId?: string, error?: string) => {
    ...
    register: (status: 'success' | 'fail', requestId: string, phone: string, ip: string, userId?: string, error?: string) => {
  ...
  rateLimit: {
    exceeded: (scope: 'phone' | 'ip' | 'combo', requestId: string, phone: string, ip: string, limit: number, remaining: number, resetSec: number) => {
  ...
  http: {
    ...
    response: (statusCode: number, url: string, headers?: any, body?: any, requestId?: string, latencyMs?: number) => {
