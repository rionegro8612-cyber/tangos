...
export class LogRetentionManager {
   ...
   * 집계 생성
   */
  private createAggregation(logs: AuditLogEntry[], period: 'hourly' | 'daily', timeKey: string): LogAggregation {
...
// ===== 초기화 완료 로그 =====
console.log('[RETENTION] Log retention management system initialized:', logRetentionManager.getRetentionStatus());
